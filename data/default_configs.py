...
# 灵植园 v2 默认配置（完整作物表见 config/garden_crops.json，此处为缺失时兜底骨架）
GARDEN_CROPS_DEFAULT = {
    "tiers": [
        ...
        {"tier": 4, "label": "灵品", "rank_min": 25, "rank_max": 31, "growth_hours": 36, "seed_cost": 2000000, "yield_min": 3, "yield_max": 3, "perfect_window_hours": 18, "wither_step_pct": 30},
        {"tier": 5, "label": "仙品", "rank_min": 0, "rank_max": 24, "growth_hours": 48, "seed_cost": 5000000, "yield_min": 3, "yield_max": 4, "perfect_window_hours": 12, "wither_step_pct": 30},
    ],
