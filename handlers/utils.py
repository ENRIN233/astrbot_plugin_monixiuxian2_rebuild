...
COMMAND_FOOTERS: dict = {
    ...
    "我的宗门": "💡 相关指令：/创建宗门 | /加入宗门 | /退出宗门 | /宗门列表 | /宗门捐献 | /宗门任务 | /宗门刷新任务 | /踢出成员 | /宗主传位 | /职位变更 | /升级修炼 | /修炼信息 | /丹房建设 | /领取丹药 | /宗门改名",
    "世界Boss": "💡 相关指令：/挑战Boss",
    "决斗": "💡 相关指令：/切磋 @玩家",
    ...
    "探索秘境": "💡 相关指令：/完成探索 | /退出秘境",
    "探险": "💡 相关指令：/进入探险 <名称> | /探险前进 [A/B] | /探险状态 | /探险撤离",
    "丹药配方": "💡 相关指令：/配方 主药<药材> <数量> 药引<药材> <数量> 辅药<药材> <数量>",
    "银行": "💡 相关指令：/存灵石 | /取灵石 | /领取利息 | /贷款 | /还款 | /银行流水 | /突破贷款 | /金银阁",
    "悬赏令": "💡 相关指令：/接取悬赏 <编号> | /悬赏状态 | /完成悬赏 | /放弃悬赏",
    "我的洞天": "💡 相关指令：/购买洞天 | /升级洞天",
    "我的灵田": "💡 相关指令：/开垦灵田 | /灵田开垦 | /灵田收取 | /升级收取 | /升级控火",
    "双修": "💡 相关指令：/接受双修 | /拒绝双修",
    ...
    try:
        ...
        if now > due_at:
            ...
            try:
                ...
                # 标记贷款逾期
                await db.ext.mark_loan_overdue(loan["id"], auto_commit=False)

                # 记录流水
                await db.ext.add_bank_transaction(
                    player.user_id, "bank_kill", 0, 0,
                    "逾期未还款，被银行追杀致死", now, auto_commit=False
                )
